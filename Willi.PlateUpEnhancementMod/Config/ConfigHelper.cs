...
namespace Willi.PlateUpEnhancementMod.Config
{
    public static class ConfigHelper
    {
        ...
        private static ConfigFile BindItemSpawnRates(this ConfigFile config)
        {
            ...
            RapidMixerSpawnRate = config.Bind("4 Custom Shop Spawn Rates", "RapidMixerSpawnRate", 0);
            ...
            ConveyorSpawnRate = config.Bind("4 Custom Shop Spawn Rates", "ConveyorSpawnRate", 0);
            CombinerSpawnRate = config.Bind("4 Custom Shop Spawn Rates", "CombinerSpawnRate", 0);
            SmartGrabberSpawnRate = config.Bind("4 Custom Shop Spawn Rates", "SmartGrabberSpawnRate", 0);
            GrabberSpawnRate = config.Bind("4 Custom Shop Spawn Rates", "GrabberSpawnRate", 0);
